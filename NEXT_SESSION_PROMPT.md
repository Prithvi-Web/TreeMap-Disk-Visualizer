...
- **Phase 3 on macOS: done except CI.** Native enum200k Turbo 412,291 entries/s, re-recorded at `17eb13d` (PASS, 2.9% faster than `54425de`'s 400,417; Tier B floor met; CURRENT-STATE §11.2). W6 (the NTFS turbo mode) complete; three security reviews before today.
