...
**State.** **CI run 36218584428 on `7e3da6b` is GREEN ON ALL FOUR LEGS** (T6 `ecd3cf2`, T6b step 1 `18c74d6`, the Windows test-render fix `9283661`, handoffs). Local `main` adds T6b step 2 `73402d0` (range jobs) + this handoff — **the owner is asked to push** (watcher `$S/watch-ci.sh`, `$S/remote-base.sha` = `7e3da6b`). Earlier: CI 36217766532 on `18c74d6` had one Windows failure, T6's queue-order test rendering paths with `display()` (`\` on Windows), fixed in `9283661`.
