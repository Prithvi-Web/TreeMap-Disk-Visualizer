...
/**
 * POST /api/nl-query { text } — plain words in, a grammar query out
 * (v4 §9.6). This endpoint TRANSLATES AND NOTHING ELSE: no hits, no totals,
 * no tree walk. Execution stays a separate, human-initiated POST /api/query
 * after the translation has been shown and possibly edited — a
